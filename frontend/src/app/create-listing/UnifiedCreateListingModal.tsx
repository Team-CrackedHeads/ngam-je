...
interface UnifiedCreateListingModalProps {
  isOpen: boolean;
  onClose: () => void;
}

type ListingType = 'choice' | 'buy' | 'sell';

export default function UnifiedCreateListingModal({ isOpen, onClose }: UnifiedCreateListingModalProps) {
  const [listingType, setListingType] = useState<ListingType>('choice');
