...
export const UNIFIED_LISTINGS: UnifiedListingData[] = [
  ...
  },
  {
    ...
    description:
      "Industry-leading noise cancellation. Perfect for travel and work.",
    price: 1060,
    currency: "MYR",
    userId: "user-1", // FK to users.id
    seller: {
  ...
  },
  {
    ...
    description:
      "Looking for daily commute. Must be in good working condition.",
    price: 3400,
    currency: "MYR",
    userId: "user-2", // FK to users.id
    seller: {
  ...
  },
  {
    ...
    description:
      "Starting photography business. Looking for professional camera body.",
    price: 6400,
    currency: "MYR",
    userId: "user-1", // FK to users.id
    seller: {
  ...
  },
  {
    ...
    description:
      "Need ergonomic chair for home office. Willing to travel for pickup.",
    price: 2550,
    currency: "MYR",
    userId: "user-2", // FK to users.id
    seller: {
...
// Helper function to get all sale listings
export function getSaleListings(): UnifiedListingData[] {
  return UNIFIED_LISTINGS.filter((listing) => listing.listingType === "sale");
}

// Helper function to get all wanted listings
export function getWantedListings(): UnifiedListingData[] {
  return UNIFIED_LISTINGS.filter((listing) => listing.listingType === "wanted");
}

// Helper function to get listings by user ID
export function getListingsByUserId(userId: string): UnifiedListingData[] {
  return UNIFIED_LISTINGS.filter((listing) => listing.userId === userId);
}

// Helper function to get user's sale listings
export function getUserSaleListings(userId: string): UnifiedListingData[] {
  return UNIFIED_LISTINGS.filter(
    (listing) => listing.userId === userId && listing.listingType === "sale"
  );
}

// Helper function to get user's wanted listings
export function getUserWantedListings(userId: string): UnifiedListingData[] {
  return UNIFIED_LISTINGS.filter(
    (listing) => listing.userId === userId && listing.listingType === "wanted"
  );
}

// Backward compatibility: Convert UNIFIED_LISTINGS to old Listing format for matching system
// TODO: Update matching system to use UnifiedListingData format and remove these
function convertToLegacyListing(
  unified: UnifiedListingData,
  numericId: number
): Listing {
  ...
  return {
    id: numericId,
    title: unified.title,
    price: unified.listingType === "sale" ? priceStr : undefined,
    budget: unified.listingType === "wanted" ? priceStr : undefined,
    location: unified.seller.location,
    timestamp: unified.seller.timePosted,
    description: unified.description,
    imageUrl: unified.imageUrl,
    views: unified.views,
    likes: 0, // Not tracked in UnifiedListingData
...
export const mockSaleListings: Listing[] = UNIFIED_LISTINGS.filter(
  (l) => l.listingType === "sale"
)
  .slice(0, 10) // Take first 10 for backwards compatibility
  .map((l, idx) => convertToLegacyListing(l, idx + 1));

export const mockWantedListings: Listing[] = UNIFIED_LISTINGS.filter(
...
export function getMockMatchedListings(): Listing[] {
  const matchedSales = mockSaleListings.filter(
    (listing) => !listing.isOwner && listing.isMatched
  );
  const matchedWanted = mockWantedListings.filter(
    (listing) => !listing.isOwner && listing.isMatched
  );
...
export interface Listing {
  ...
  userId: string; // Owner's user ID (user-1 = Fitri, user-2 = Sani)
  isOwner?: boolean; // DEPRECATED: Use userId instead. Kept for backward compatibility
...
export const conversationsData: ConversationData[] = [
  {
    ...
    messages: [
      // { id: "m0", sender: "them", content: "", timestamp: "10:00 AM", product: { title: "Nike Air Max - Blue/Orange", price: "$299.9", image: "/shoe.png" } },
      {
        id: "m1",
        sender: "them",
        content: "Hey! Is the Nike Air Max still available?",
        timestamp: "10:00 AM",
      },
      {
        id: "m2",
      ...
      },
      {
        id: "m3",
        sender: "them",
        content: "Awesome, can you hold it for me until tomorrow?",
        timestamp: "10:02 AM",
      },
      {
        id: "m4",
        sender: "me",
        content:
          "Sure, I can hold it for 24 hours. After that I'll have to open it back up.",
        timestamp: "10:03 AM",
      },
      {
        id: "m5",
        sender: "them",
        content: "Perfect! What's your location?",
        timestamp: "10:04 AM",
      },
      {
        id: "m6",
        sender: "me",
        content: "I'm near downtown, close to the metro station.",
        timestamp: "10:05 AM",
      },
      {
        id: "m7",
        sender: "them",
        content: "Great! That works for me. Can we meet there tomorrow at 3pm?",
        timestamp: "10:06 AM",
      },
      {
        id: "m8",
        sender: "me",
        content:
          "3pm works perfectly. I'll be at the coffee shop next to the station.",
        timestamp: "10:07 AM",
      },
      {
        id: "m9",
        sender: "them",
        content: "Sounds good! Should I bring cash or can you take Venmo?",
        timestamp: "10:08 AM",
      },
      {
        id: "m10",
        sender: "me",
        content:
          "Either works for me! Cash is preferred but Venmo is fine too.",
        timestamp: "10:09 AM",
      },
      {
        id: "m11",
        sender: "them",
        content: "I'll bring cash then. See you tomorrow!",
        timestamp: "10:10 AM",
      },
      {
        id: "m12",
        sender: "me",
        content: "See you then! Text me if anything comes up.",
        timestamp: "10:11 AM",
      },
      {
        id: "m13",
      ...
      },
      {
        id: "m15",
        sender: "them",
        content: "By the way, what size are they?",
        timestamp: "10:15 AM",
      },
      {
        id: "m16",
        sender: "me",
        content: "They're size 10.5, US men's sizing.",
        timestamp: "10:16 AM",
      },
      {
        id: "m17",
        sender: "them",
        content: "Perfect, that's my size!",
        timestamp: "10:17 AM",
      },
      {
        id: "m18",
        sender: "me",
        content: "Awesome! They're in great condition too, barely worn.",
        timestamp: "10:18 AM",
      },
      {
        id: "m19",
        sender: "them",
        content: "Even better. Looking forward to tomorrow!",
        timestamp: "10:19 AM",
      },
      {
        id: "m20",
        sender: "me",
        content: "Same here! Talk soon.",
        timestamp: "10:20 AM",
      },
    ],
  },
  {
    ...
    messages: [
      ...
      },
      {
        id: "m2",
        sender: "me",
        content: "That's great! Can you send me the details?",
        timestamp: "9:32 AM",
      },
      {
        id: "m3",
        sender: "them",
        content:
          "Sure! The first one is a 2021 model with M1 chip, 16GB RAM, 512GB SSD for $1200.",
        timestamp: "9:33 AM",
      },
      {
        id: "m4",
        sender: "me",
        content: "What about the other two?",
        timestamp: "9:34 AM",
      },
      {
        id: "m5",
        sender: "them",
        content: "Second one is 2020 Intel i7, 16GB RAM, 1TB SSD for $1100.",
        timestamp: "9:35 AM",
      },
      {
        id: "m6",
        sender: "them",
        content: "And the third is 2022 M2, 24GB RAM, 1TB SSD for $1800.",
        timestamp: "9:36 AM",
      },
      {
        id: "m7",
        sender: "me",
        content: "The M1 sounds good. Is it in good condition?",
        timestamp: "9:38 AM",
      },
      {
        id: "m8",
        sender: "them",
        content: "Yes, it's in excellent condition with minimal wear.",
        timestamp: "9:39 AM",
      },
    ],
  },
    ...
    messages: [
      {
        id: "m1",
        sender: "me",
        content: "Perfect! I'll take it. When can we meet?",
        timestamp: "Yesterday",
      },
      {
        id: "m2",
        sender: "them",
        content: "Tomorrow evening works for me.",
        timestamp: "Yesterday",
      },
      {
        id: "m3",
        sender: "me",
        content: "What time exactly?",
        timestamp: "Yesterday",
      },
      {
        id: "m4",
        sender: "them",
        content: "How about 6pm?",
        timestamp: "Yesterday",
      },
      {
        id: "m5",
        sender: "me",
        content: "That works! Where should we meet?",
        timestamp: "Yesterday",
      },
      {
        id: "m6",
        sender: "them",
        content: "There's a Starbucks on Main Street. That good for you?",
        timestamp: "Yesterday",
      },
    ],
  },
  {
    ...
    messages: [
      ...
      },
      {
        id: "m3",
        sender: "them",
        content: "Please let me know if it's still available",
        timestamp: "1:10 AM",
      },
    ],
  },
...
// Current logged-in user (User 1 = Fitri)
  ...
  if (listingId === 1 && listingType === "sale") {
    ...
    matches.push({
      ...
      matchReasons: [
        ...
        },
        {
          ...
          label: "Same location",
          matched: true,
          details: "Kuala Lumpur",
        },
        {
          type: "price",
          label: "Price compatible",
          matched: true,
    ...
    matches.push({
      ...
      matchReasons: [
        ...
        {
          type: "price",
          label: "Different price range",
          matched: false,
          details: "Price gap: RM 5,100",
        },
        {
          type: "keyword",
          label: "Related products",
          matched: true,
          details: "Apple ecosystem",
        },
      ],
      distance: "Same city",
    ...
    matches.push({
      ...
      matchReasons: [
        ...
        },
        {
          ...
          label: "Lower budget",
          matched: false,
          details: "Price gap: RM 1,700",
        },
        {
          type: "keyword",
          label: "Related products",
          matched: true,
          details: "Apple products",
        },
      ],
      distance: "12km away",
    ...
    matches.push({
      ...
      matchReasons: [
        ...
        },
        {
          ...
          label: "Nearby location",
          matched: true,
          details: "Kuala Lumpur & Petaling Jaya",
        },
        {
          type: "price",
          label: "Price match",
    ...
    matches.push({
      ...
      matchReasons: [
        ...
        },
        {
          ...
          label: "Nearby location",
          matched: true,
          details: "Petaling Jaya",
        },
        {
          type: "price",
          label: "Close to budget",
          matched: true,
          details: "Slightly lower than budget",
        },
        {
          type: "keyword",
          label: "Similar product",
...
export function getAllUserMatches(
  userListingIds: number[]
): Map<number, ListingMatch[]> {
  ...
  userListingIds.forEach((id) => {
    ...
    const matches = generateMatchesForListing(
      id,
      isSaleListing ? "sale" : "wanted"
    );
    if (matches.length > 0) {
...
export const mockAIMatchings: MatchedListing[] = [
  {
    ...
    description:
      "Professional-grade laptop for video editing. Barely used, comes with original box and accessories. Perfect for creative professionals.",
    price: 8500,
    originalAsk: 9000,
  ...
  },
  {
    ...
    description:
      "Lightly used MacBook Pro perfect for creative work. 512GB SSD, 16GB RAM. Upgraded recently.",
    price: 7800,
    originalAsk: 8500,
    images: ["https://via.placeholder.com/400x300"],
  ...
  },
  {
    ...
    description:
      "Previous generation but still powerful. Great condition, well maintained. Includes AppleCare+ warranty.",
    price: 6500,
    originalAsk: 7000,
    images: ["https://via.placeholder.com/400x300"],
  ...
  },
  {
    ...
    description:
      "Top-tier configuration with 32GB RAM and 1TB SSD. Used for professional video editing. Pristine condition.",
    price: 9500,
    originalAsk: 10000,
    images: ["https://via.placeholder.com/400x300"],
  ...
  },
  {
    ...
    description:
      "Highest spec M3 Max chip for heavy video editing and 3D work. 64GB RAM, 2TB SSD. Barely used, 2 months old.",
    price: 11000,
    originalAsk: 12000,
    images: ["https://via.placeholder.com/400x300"],
...
export const userAIListing: MatchedListing = {
  ...
  description:
    "I need a MacBook Pro M3 for professional video editing work. Must be in excellent condition with at least 16GB RAM.",
  price: 8000,
  originalAsk: 8000,
  images: ["https://via.placeholder.com/400x300"],
...
export const mockSearchSuggestions: SearchSuggestion[] = [
  ...
  {
    id: "chat-motorcycle-maintenance",
    type: "chat",
    ...
    messages: [
      {
        id: "1-1",
        role: "user",
        content: "Compare iPhone 14 Pro prices",
        timestamp: new Date("2025-10-03T13:58:00Z"),
      },
      {
        id: "1-2",
        role: "assistant",
        content: "Searching for iPhone 14 Pro deals...",
        timestamp: new Date("2025-10-03T13:58:10Z"),
      },
      {
        id: "1-3",
        role: "assistant",
        content:
          "Found several options. The best deal is RM4500 from Seller A.",
        timestamp: new Date("2025-10-03T13:58:30Z"),
      },
    ],
  },
  {
    ...
    messages: [
      {
        id: "2-1",
        role: "user",
        content: "Find gaming PCs under RM4000",
        timestamp: new Date("2025-10-03T10:59:00Z"),
      },
      {
        id: "2-2",
        role: "assistant",
        ...
        timestamp: new Date("2025-10-03T10:59:10Z"),
        toolCalls: [
          {
      ...
      },
      {
        ...
        timestamp: new Date("2025-10-03T10:59:40Z"),
      },
    ],
  },
  {
    ...
    messages: [
      {
        id: "3-1",
        role: "user",
        content: "Is this Nintendo Switch seller reliable?",
        timestamp: new Date("2025-10-02T15:58:00Z"),
      },
      {
        id: "3-2",
        role: "assistant",
        content: "Checking seller ratings and reviews...",
        timestamp: new Date("2025-10-02T15:58:05Z"),
        toolCalls: [
          {
            name: "verify_sellers",
            status: "completed",
            result: "Seller 'GameMaster' has a 4.8-star rating",
          },
        ],
      },
      {
        ...
        role: "assistant",
        content:
          "Seller 'GameMaster' has a 4.8-star rating with over 500 sales. They are highly reliable.",
        timestamp: new Date("2025-10-02T15:58:20Z"),
      },
    ],
  },
  {
...
// ============================================================================
// UI CONFIGURATION DATA (Filter/Sort/Tags)
// ============================================================================

// Sidebar - Chat History (alternative to mockSearchSuggestions)
export const SIDEBAR_CHAT_HISTORY = [
  {
    id: 1,
    title: "iPhone 14 Pro price comparison",
    timestamp: "2 hours ago",
...
// Sorting Component - Primary Filter Buttons
export const PRIMARY_FILTER_BUTTONS = [
  {
    label: "Verified",
...
// Sorting Component - Quick Filter Options
export const QUICK_FILTER_OPTIONS = [
  { label: "Protected Listings", filter: "Protected Listings", icon: "🔒" },
  { label: "Posted Today", filter: "Posted Today", icon: "🕒" },
  { label: "High Views", filter: "High Views", icon: "👁️" },
  { label: "Has Gallery", filter: "Has Gallery", icon: "🖼️" },
];

// Sorting Component - Quick Sort Options
export const QUICK_SORT_OPTIONS = [
  ...
  { label: "Highest Price", sort: "Highest Price", icon: "💎" },
  { label: "Most Views", sort: "Most Views", icon: "👁️" },
];

// SearchFilter Component - Available Tags
...
// SearchFilter Component - Sort Options
...
// SearchFilter Component - Listing Type Options
...
// ============================================
// CREATE LISTING - FAQ GENERATION DATA
// ============================================
...
export const MOCK_FAQ_BUY: FAQ[] = [
  {
    ...
    answer:
      "I prefer gently used to new condition. Minor wear is acceptable if reflected in the price. The item must have no major defects, sole separation, or structural damage.",
  },
  {
    id: (Date.now() + 1).toString(),
    question: "Do you need the original box and accessories?",
    answer:
      "Original box and accessories are preferred but not mandatory. Items with complete packaging may be valued higher within my budget range.",
  },
  {
    id: (Date.now() + 2).toString(),
    question: "What sizes are you interested in?",
    answer:
      "I'm open to various sizes. Please specify the size you have available when making an offer.",
  },
];
...
export const MOCK_FAQ_SELL: FAQ[] = [
  {
    ...
    answer:
      "Yes, all items listed are guaranteed to be 100% authentic. I can provide proof of purchase or authentication certificates upon request.",
  },
  {
    id: (Date.now() + 1).toString(),
    question: "What is the return policy?",
    answer:
      "Returns are accepted within 3 days of delivery if the item is not as described. The item must be in the same condition as received. Return shipping costs are covered by the buyer unless the item has defects.",
  },
  {
    id: (Date.now() + 2).toString(),
    question: "How quickly can you ship?",
    answer:
      "I typically ship within 1-2 business days after receiving payment. You will receive tracking information once the item is shipped.",
  },
];

// ============================================
// CREATE LISTING - TAG GENERATION DATA
// ============================================
...
// ============================================
// CREATE LISTING - AI GENERATION DATA (BUY)
// ============================================

export const MOCK_GENERATED_TITLE_BUY = "Looking for MacBook Air M2";

export const MOCK_GENERATED_DESCRIPTION_BUY = `Seeking a MacBook Air M2 in excellent or like-new condition. Ideal for students or professionals looking for a reliable and portable laptop.

Key Features Desired:
• Model: MacBook Air M2
• RAM: 8GB (minimum)
• Storage: 256GB SSD (minimum)
• Condition: Excellent to Like New (minimal signs of wear)
• Color: Any color accepted (Space Gray, Silver, Midnight, Starlight)
• Original box and accessories (charger, cable) preferred
• Receipt included (preferred for warranty purposes)

Condition: Must be fully functional with no major defects, screen issues, or battery degradation. Minor cosmetic wear is acceptable if reflected in the price.

Additional Preferences:
• Cash Preferred
• Meet-up Available (in Petaling Jaya or nearby areas)
• Verified seller with good ratings preferred`;

export const MOCK_GENERATED_IMAGES_BUY = [
  "https://images.unsplash.com/photo-1517336714731-489689fd1ca8?q=80&w=1170&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D",
  ...
  "https://images.unsplash.com/photo-1501163268664-3fdf329d019f?ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&q=80&w=2670",
];

// ============================================
// CREATE LISTING - AI GENERATION DATA (SELL)
// ============================================

export const MOCK_GENERATED_TITLE_SELL = "MacBook Air M2 256GB";

export const MOCK_GENERATED_DESCRIPTION_SELL = `Perfect for students and professionals. This MacBook Air M2 features 8GB RAM and a 256GB SSD, offering excellent performance for everyday tasks and more.
...
export const MOCK_GENERATED_IMAGES_SELL = [
  "https://images.unsplash.com/photo-1651241680016-cc9e407e7dc3?ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxzZWFyY2h8MTh8fG1hY2Jvb2t8ZW58MHx8MHx8fDA%3D&auto=format&fit=crop&q=60&w=500",
  "https://images.unsplash.com/photo-1616400619175-5beda3a17896?ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&q=80&w=1548",
];

export const MOCK_OWNERSHIP_PROOF_IMAGE_SELL =
...
// ============================================
// LOCATION DATA (for dropdowns/filters)
// ============================================
...
// ============================================
// PRICE HISTORY DATA (for charts/analytics)
// ============================================
