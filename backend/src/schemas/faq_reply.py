...
class FAQReplyCreate(FAQReplyBase):
    ...
    parent_reply_id: Optional[int] = Field(None, description="ID of parent reply for nested replies")
...
class FAQReplyNested(FAQReplyResponse):
    ...
    replies: List['FAQReplyNested'] = Field(default_factory=list, description="Nested child replies")
